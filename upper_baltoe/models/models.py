...
class Contracts(models.Model):
    ...
    customer_id = fields.Many2one('ub_customer')
    contract_type = fields.Selection(selection=[('one', 'One Time'), ('subs', 'Subscription'), ])
    service_id = fields.Many2one('ub_service')
    ...
    creator_id = fields.Many2one('ub_employee')
...
class Employees(models.Model):
    ...
    job_id = fields.Many2one('ub_job')
    department_id = fields.Many2one('ub_department')
    company = fields.Selection(selection=[('upper', 'Upper Medic'), ('baltoe', 'Baltoe'), ('common', 'Common'), ], )
...
class AccGuide(models.Model):
    ...
    parent_id = fields.Many2one('ub_accguide')
...
class Income(models.Model):
    ...
    contract_id = fields.Many2one('ub_contract')
    ...
    company_account_id = fields.Many2one('ub_accguide')
    doctype = fields.Many2one('ub_doctype')
    company = fields.Selection(selection=[('upper', 'Upper Medic'), ('baltoe', 'Baltoe')], )
...
class JE(models.Model):
    ...
    costcenter_id = fields.Many2one('ub_costcenter')
    creation_date = fields.Date()
    due_date = fields.Date()
    contract_id = fields.Many2one('ub_contract')
    customer_id = fields.Many2one(related='contract_id.customer_id')
    ...
    doctype = fields.Many2one('ub_doctype')
    company_account_id = fields.Many2one('ub_accguide')
    on_account = fields.Many2one('ub_accguide')
    att_files = fields.Binary(string="Attachments", )
    active = fields.Boolean(default=True)
